  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Ali Javidan",
        text: "Hello, I'm a Full-stack Java Web Developer. Find out more in my live-resume!",
        url: "https://alijavidan.github.io.com/live-resume"
      });
    } catch(error) {
