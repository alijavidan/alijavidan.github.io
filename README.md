> [切换到中文版](https://github.com/alijavidan/live-resume/blob/master/README-ZH.md)
...
* A complete [Wiki](https://github.com/alijavidan/live-resume/wiki) that provides support;
...
* Composed of 5 custom sections ([Welcome](https://alijavidan.github.io.com/live-resume/), [About Me](https://alijavidan.github.io.com/live-resume/about), [Experiences](https://alijavidan.github.io.com/live-resume/experience), [Posts](https://alijavidan.github.io.com/live-resume/posts), and [Contact](https://alijavidan.github.io.com/live-resume/contact));
* Router fragment friendly (e.g: https://alijavidan.github.io.com/live-resume/posts );
* Source code verified by static code analyzers _(safe and ready for production)_;

## Changelog
[Learn about the latest improvements.](https://github.com/alijavidan/live-resume/CHANGELOG.md)

## 🗂 Wiki Documentation & 💬 Community Chat

To get more help on the setup, customization or any other aspect, accessing the following:

* [Wiki on GitHub](https://github.com/alijavidan/live-resume/wiki) - A complete documentation, from _getting started_ until _deploy_.
...
In the [Wiki Doc.](https://github.com/alijavidan/live-resume/wiki/applying-customizations) there is a specific page supporting you on how to apply customizations to the layout and more... [See page](https://github.com/alijavidan/live-resume/wiki/applying-customizations)
...
> Site [www.alijavidan.com](https://www.alijavidan.com)<br>
